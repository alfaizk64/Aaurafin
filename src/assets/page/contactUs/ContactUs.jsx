...
//                  </p>
//               </h1>
//               <p className="poppins-regular text-[24px] mobile_para_font mt-[18px] lg:mt-[25px]">Have Questions? We're Here to Help!</p>
//               <div className="flex flex-col lg:flex-row gap-[20px] lg:gap-[60px] mt-[30px] lg:mt-[60px] py-4 border-b  border-t border-[#000D1E33] ">
//                 <div  className="flex ">
//                   <img  height={52} width={52} src="/contactus/Group 1000004736.png"/>
//                   <div>
//                      <p className=" text-[#6E7984] poppins-medium text-[16px]">Phone</p>
//                       <p className="poppins-medium text-[20px]">022 2088 0099</p>
//                    </div>
//                 </div>
//                 <div className="flex">
//                   <img  height={52} width={52} src="/contactus/Group 1000004736 (1).png"/>
//                   <div>
//                      <p className=" text-[#6E7984] poppins-medium text-[16px]">Email</p>
//                       <p className="poppins-medium text-[20px]">info@9abusiness.com</p>
//                    </div>
//                 </div>
//               </div>
//               <div className="mt-[30px] flex-col flex">
//                    <img height={52} width={52} src="/contactus/Group 1000004736 (2).png"/>
//                    <div className="flex flex-col max-w-[480px]">
//                      <p className="text-[#6E7984] poppins-medium text-[16px] mt-[14px]">Address</p>
//                      <p className="poppins-medium text-[#000000] mt-[7px] text-[18px]">Unit No-904, Lodha Supremus Building, Opp. 
//                               Sakivihar Telephone Exchange, Sakivihar Road,
//                               Powai, Mumbai-400072, India.</p>
//                    </div>
//               </div>
//              </div>
//          </div>
...
//             className=" w-full lg:w-1/2 rounded-xl shadow-2xl  lg:absolute z-40 lg:max-w-[473px] xl:right-[230px]  xl:top-[119px] bg-white p-4">
//               <form onSubmit={handleSubmit} className="space-y-4 w-full flex flex-col justify-center">
//                 {/* Name Field */}
//                  <p className="text-[#6E7984] text-[18px] font-normal sf-pro pt-[20px]">Please fill the below form to connect us.</p>
//                 <div
...
//                       focusedField === "name" || formData.name
//                         ? "-translate-y-7 translate-x-0 scale-75 text-blue-600 bg-white px-2"
//                         : "text-gray-500"
//                     }`}
//                   >
//                     Enter Your Name
...
//                 <button
//                   type="submit"
//                   className={`px-[30px] self-center text-white sf-pro py-[12px] bg-[#0E0E83] rounded-full transition-all duration-300 
//             hover:bg-blue-700 ${
...
//             </motion.div>
//           </div>
//          <div className="lg:w-[40%]  z-10 bg-[#156CDA]  ">
//             <img src="/contactus/Mask group (1).png"/>
//          </div>
//       </section>
        


//       <div className="inset-0 absolute z-10 bg-cover " style={{backgroundImage:"url('/contactus/Group 1000004727.png')"}}></div>
