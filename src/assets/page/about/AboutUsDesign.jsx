                              ...
                              <div className="listar-feature-block-content-wrapper">
                                ...
                                <div className="listar-feature-content-wrapper" style={{paddingTop: 0}}>
                                  <div className="listar-feature-item-title listar-feature-counter-added">
                                    <span className='' ><span>0{index}</span>
                                    {item.title} </span>
                                  </div>
                                  <div className="listar-feature-item-excerpt md:mt-[6px] mt-[4px] mobile_para_font poppins-regular lg:text-justify text-[#12122A] text-[16px] md:text-[18px] leading-[30px]">
